...
/// # field meaning:
/// - extra: API of the contract
/// Example{"type":"function", "inputs": [{"name":"a","type":"uint256"}], "name":"foo", "outputs": []}
///
/// - reference: Link to the contract wasm file
/// - reference_hash: Hash of the wasm file
